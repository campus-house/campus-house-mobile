...
import EmailAuthCompleteScreen from './EmailAuthCompleteScreen';

interface EmailAuthScreenProps {
  onBack?: () => void;
}

export default function EmailAuthScreen({ onBack }: EmailAuthScreenProps) {
  ...
  if (showComplete) {
    return <EmailAuthCompleteScreen onBack={() => setShowComplete(false)} />;
  }
