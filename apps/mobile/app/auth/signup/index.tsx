...
export default function TermsAgreementScreen() {
  const [terms, setTerms] = useState<TermItem[]>([
    ...
    { id: 'third-party', title: '개인정보 제3자 정보제공 동의', isRequired: false, isSelected: false },
  ]);
  ...
  const isRequiredTermsAgreed = terms.filter(term => term.isRequired).every(term => term.isSelected);
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <TouchableOpacity 
        style={[
          styles.agreeButton, 
          isAgreeButtonEnabled && styles.agreeButtonEnabled
        ]} 
        onPress={handleAgree}
      ...
      >
        <Text style={[
          ...
          isAgreeButtonEnabled && styles.agreeButtonTextEnabled
        ]}>
          동의하기
        </Text>
      </TouchableOpacity>
