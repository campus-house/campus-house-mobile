...
export default function IdentityVerificationScreen() {
  ...
  const isFormValid = name.length > 0 && birthDate.length === 6 && rrnFirstDigit.length === 1 && phoneNumber.length > 0 && selectedCarrier.length > 0 && verificationCode.length === 6;
        ...
        <View style={styles.inputSection}>
          ...
          <View style={styles.inputContainer}>
            ...
            <View style={[
              ...
              isNameFocused && styles.inputUnderlineFocused
            ]} />
          </View>
        </View>
        ...
        <View style={styles.inputSection}>
          ...
          <View style={styles.rrnContainer}>
            ...
            <View style={styles.rrnInputContainer}>
              ...
              <View style={[
                styles.rrnUnderline,
                isBirthDateFocused && styles.rrnUnderlineFocused
              ]} />
            </View>
            ...
            <View style={styles.rrnFirstDigitContainer}>
              <TextInput
                style={[
                  ...
                  (isRrnFirstDigitFocused || rrnFirstDigit.length > 0) && styles.rrnFirstDigitInputFocused
                ]}
                value={rrnFirstDigit}
        ...
        <View style={styles.inputSection}>
          ...
          <View style={styles.phoneContainer}>
            ...
            >
              <Text style={[
                styles.carrierText,
                selectedCarrier && styles.carrierTextSelected
              ]}>
                {selectedCarrier || '통신사'}
              </Text>
            ...
            <View style={styles.phoneNumberContainer}>
              ...
              <View style={[
                ...
                isPhoneFocused && styles.phoneUnderlineFocused
              ]} />
            </View>
              ...
              <View style={styles.verificationCodeInputContainer}>
                <TextInput
                  style={[
                    ...
                    (isVerificationCodeFocused || verificationCode.length > 0) && styles.verificationCodeInputFocused
                  ]}
                  ...
                  placeholder={isVerificationCodeFocused || verificationCode.length > 0 ? '' : '인증번호 입력'}
                  placeholderTextColor={COLORS.neutral.grey3}
                  keyboardType="numeric"
                  maxLength={6}
                />
