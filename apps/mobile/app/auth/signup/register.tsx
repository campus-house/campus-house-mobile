...
export default function RegisterScreen() {
  ...
  const isFormValid = userId.length > 0 && password.length > 0 && confirmPassword.length > 0 && password === confirmPassword && !isPasswordError && !isConfirmPasswordError;
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <TouchableOpacity style={styles.backButton}>
        <Svg width="10" height="19.091" viewBox="0 0 10 19.091" fill="none">
          <Path d="M8.5 1L1 9.5455L8.5 18.091" stroke={COLORS.neutral.grey4} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </Svg>
      </TouchableOpacity>
      ...
      <View style={styles.inputSection}>
        ...
        {/* 아이디 오류 메시지 */}
        {isUserIdError && (
          <Text style={styles.userIdErrorText}>이미 존재하는 아이디입니다.</Text>
        )}
        
        {/* 아이디 성공 메시지 */}
        {isUserIdSuccess && (
          <Text style={styles.userIdSuccessText}>사용 가능한 아이디입니다!</Text>
        )}
      </View>
        ...
        <View style={styles.inputContainer}>
          <View style={styles.passwordInputContainer}>
            ...
            <TextInput
              style={[
                styles.passwordTextInput,
                (isConfirmPasswordFocused || confirmPassword.length > 0) && styles.passwordTextInputFocused
              ]}
              ...
              placeholder={isConfirmPasswordFocused || confirmPassword.length > 0 ? '' : '비밀번호 재입력'}
              placeholderTextColor={COLORS.neutral.grey3}
              secureTextEntry={false}
              autoCapitalize="none"
              keyboardType="default"
